...
public abstract class MonoBehaviourObjectPool<PoolType, ObjectType> : SingletonBehaviour<PoolType> where PoolType : MonoBehaviour where ObjectType : MonoBehaviour {
